...
// Add new variables to track the color palette indices
uint8_t startIndex;
uint8_t colorIndex;
...
void TimeUpdateFT()
{
  ...
  colorIndex = startIndex;  // Reset the color Index to the Start Index
  ...
  startIndex += 30; // Increment the startIndex to change the rainbow's starting point on the next time update
